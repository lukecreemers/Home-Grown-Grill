...
#item represents the name of each individual item with price
...
#item_name represents the name of each individual item without price
item1_name = "Apple"
item2_name = "Milk"
item3_name = "Carrot"
item4_name = "Cracker"
...
class HGGPage1(QDialog):
    ...
    def __init__(self):
        ...
        loadUi('internalproject1.1.ui', self)
        self.setWindowTitle('Home Grown Grill')
        self.nextButton.clicked.connect(self.on_nextButton_clicked)
        self.pushButton.clicked.connect(self.on_pushButton_clicked)

        Background = QImage("HomegrownGrill.png")
        BackgroundSize = Background.scaled(QSize(960, 540))
        palette = QPalette()
        palette.setBrush(10, QBrush(BackgroundSize))
...
class HGGPage2(QDialog):
    ...
    def __init__(self):
        ...
        loadUi('internalproject2.1.ui',self)
        self.setWindowTitle('Home Grown Grill')
    ...
    def totalcost(self):
        ...
        global item1_name_final
        global item2_name_final
        global item3_name_final
        global item4_name_final
        global item5_name_final
        global item6_name_final
        global item7_name_final
        global item8_name_final
        global item9_name_final
        global item10_name_final

        spinbox_used_1 = False
        spinbox_used_2 = False
        spinbox_used_3 = False
        spinbox_used_4 = False
        spinbox_used_5 = False
        spinbox_used_6 = False
        spinbox_used_7 = False
        spinbox_used_8 = False
        spinbox_used_9 = False
        spinbox_used_10 = False

        #price return #1
        if self.spinBox.value() > 0:
            item_1 = self.spinBox.value() * spinval
            item1_name_final = item1_name
            spinbox_used_1 = True
        elif self.spinBox2.value() > 0:
            item_1 = self.spinBox3.value() * spinval3
            item1_name_final = item2_name
            spinbox_used_2 = True
        elif self.spinBox3.value() > 0:
            item_1 = self.spinBox3.value() * spinval3
            item1_name_final = item3_name
            spinbox_used_3 = True
        elif self.spinBox4.value() > 0:
            item_1 = self.spinBox4.value() * spinval4
            item1_name_final = item4_name
            spinbox_used_4 = True
        elif self.spinBox5.value() > 0:
            item_1 = self.spinBox5.value() * spinval5
            item1_name_final = item5_name
            spinbox_used_5 = True
        elif self.spinBox6.value() > 0:
            item_1 = self.spinBox6.value() * spinval6
            item1_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0:
            item_1 = self.spinBox7.value() * spinval7
            item1_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0:
            item_1 = self.spinBox8.value() * spinval8
            item1_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0:
            item_1 = self.spinBox9.value() * spinval9
            item1_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0:
            item_1 = self.spinBox10.value() * spinval10
            item1_name_final = item10_name
            spinbox_used_10 = True

        #price return #2
        if self.spinBox2.value() > 0 and spinbox_used_2 == False:
            item_2 = self.spinBox2.value() * spinval2
            item2_name_final = item2_name
            spinbox_used_2 = True
        elif self.spinBox3.value() > 0 and spinbox_used_3 == False:
            item_2 = self.spinBox3.value() * spinval3
            item2_name_final = item3_name
            spinbox_used_3 = True
        elif self.spinBox4.value() > 0 and spinbox_used_4 == False:
            item_2 = self.spinBox4.value() * spinval4
            item2_name_final = item4_name
            spinbox_used_4 = True
        elif self.spinBox5.value() > 0 and spinbox_used_5 == False:
            item_2 = self.spinBox5.value() * spinval5
            item2_name_final = item5_name
            spinbox_used_5 = True
        elif self.spinBox6.value() > 0 and spinbox_used_6 == False:
            item_2 = self.spinBox6.value() * spinval6
            item2_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_2 = self.spinBox7.value() * spinval7
            item2_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_2 = self.spinBox8.value() * spinval8
            item2_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_2 = self.spinBox9.value() * spinval9
            item2_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_2 = self.spinBox10.value() * spinval10
            item2_name_final = item10_name
            spinbox_used_10 = True

        #price return #3
        if self.spinBox3.value() > 0 and spinbox_used_3 == False:
            item_3 = self.spinBox3.value() * spinval3
            item3_name_final = item3_name
            spinbox_used_3 = True
        elif self.spinBox4.value() > 0 and spinbox_used_4 == False:
            item_3 = self.spinBox4.value() * spinval4
            item3_name_final = item4_name
            spinbox_used_4 = True
        elif self.spinBox5.value() > 0 and spinbox_used_5 == False:
            item_3 = self.spinBox5.value() * spinval5
            item3_name_final = item5_name
            spinbox_used_5 = True
        elif self.spinBox6.value() > 0 and spinbox_used_6 == False:
            item_3 = self.spinBox6.value() * spinval6
            item3_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_3 = self.spinBox7.value() * spinval7
            item3_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_3 = self.spinBox8.value() * spinval8
            item3_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_3 = self.spinBox9.value() * spinval9
            item3_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_3 = self.spinBox10.value() * spinval10
            item3_name_final = item10_name
            spinbox_used_10 = True


#price return #4
        if self.spinBox4.value() > 0 and spinbox_used_4 == False:
            item_4 = self.spinBox4.value() * spinval4
            item4_name_final = item4_name
            spinbox_used_4 = True
        elif self.spinBox5.value() > 0 and spinbox_used_5 == False:
            item_4 = self.spinBox5.value() * spinval5
            item4_name_final = item5_name
            spinbox_used_5 = True
        elif self.spinBox6.value() > 0 and spinbox_used_6 == False:
            item_4 = self.spinBox6.value() * spinval6
            item4_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_4 = self.spinBox7.value() * spinval7
            item4_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_4 = self.spinBox8.value() * spinval8
            item4_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_4 = self.spinBox9.value() * spinval9
            item4_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_4 = self.spinBox10.value() * spinval10
            item4_name_final = item10_name
            spinbox_used_10 = True

        #price return #5
        if self.spinBox5.value() > 0 and spinbox_used_5 == False:
            item_5 = self.spinBox5.value() * spinval5
            item5_name_final = item5_name
            spinbox_used_5 = True
        elif self.spinBox6.value() > 0 and spinbox_used_6 == False:
            item_5 = self.spinBox6.value() * spinval6
            item5_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_5 = self.spinBox7.value() * spinval7
            item5_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_5 = self.spinBox8.value() * spinval8
            item5_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_5 = self.spinBox9.value() * spinval9
            item5_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_5 = self.spinBox10.value() * spinval10
            item5_name_final = item10_name
            spinbox_used_10 = True

        #price return #6
        if self.spinBox6.value() > 0 and spinbox_used_6 == False:
            item_6 = self.spinBox6.value() * spinval6
            item6_name_final = item6_name
            spinbox_used_6 = True
        elif self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_6 = self.spinBox7.value() * spinval7
            item6_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_6 = self.spinBox8.value() * spinval8
            item6_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_6 = self.spinBox9.value() * spinval9
            item6_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_6 = self.spinBox10.value() * spinval10
            item6_name_final = item10_name
            spinbox_used_10 = True

        #price return #7
        if self.spinBox7.value() > 0 and spinbox_used_7 == False:
            item_7 = self.spinBox7.value() * spinval7
            item7_name_final = item7_name
            spinbox_used_7 = True
        elif self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_7 = self.spinBox8.value() * spinval8
            item7_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_7 = self.spinBox9.value() * spinval9
            item7_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_7 = self.spinBox10.value() * spinval10
            item7_name_final = item10_name
            spinbox_used_10 = True

        #price return #8
        if self.spinBox8.value() > 0 and spinbox_used_8 == False:
            item_8 = self.spinBox8.value() * spinval8
            item8_name_final = item8_name
            spinbox_used_8 = True
        elif self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_8 = self.spinBox9.value() * spinval9
            item8_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_8 = self.spinBox10.value() * spinval10
            item8_name_final = item10_name
            spinbox_used_10 = True

        #price return #9
        if self.spinBox9.value() > 0 and spinbox_used_9 == False:
            item_9 = self.spinBox9.value() * spinval9
            item9_name_final = item9_name
            spinbox_used_9 = True
        elif self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_9 = self.spinBox10.value() * spinval10
            item9_name_final = item10_name
            spinbox_used_10 = True

        #price return #10
        if self.spinBox10.value() > 0 and spinbox_used_10 == False:
            item_10 = self.spinBox10.value() * spinval10
            item10_name_final = item10_name
            spinbox_used_10 = True
...
class HGGPage3(QDialog):
    ...
    def __init__(self):
        ...
        loadUi('internalproject3.1.ui',self)
        self.setWindowTitle('Home Grown Grill')
        self.backButton.clicked.connect(self.on_backButton_clicked)
        self.closeButton.clicked.connect(self.on_closeButton_clicked)
        self.nextButton.clicked.connect(self.on_nextButton_clicked)
...
class HGGPage4(QDialog):
    ...
    def __init__(self):
        ...
        self.nextButton.clicked.connect(self.on_nextButton_clicked)
        self.setMinimumSize(QSize(687, 300))
        self.checkBox.setText("Pickup:")
        self.checkBox_2.setText("Delivery (Additional 3$):")
    ...
    def on_nextButton_clicked(self):
        ...
        #cost_after_paper is a variable that is set equal to the final 'value' plus one, this is used in the final cost summary
        if self.checkBox.isChecked() and checkbox_2 == False:
            global cost_after_delivery
            global cost_after_paper
            cost_after_delivery = cost_after_paper + 3
            if cost_after_delivery == cost_after_paper + 3:
                cost_after_delivery = cost_after_delivery - 3
            self.widget = HGGPage5()
            self.widget.show()
            self.hide()
        elif self.checkBox_2.isChecked() and checkbox_1 == False:
            cost_after_delivery = cost_after_paper + 3
...
class HGGPage5(QDialog):
    ...
    #Initialising
    def __init__(self):
        super(HGGPage5,self).__init__()
        loadUi('internalproject4.4.ui',self)
        self.setWindowTitle('Home Grown Grill')
        self.setMinimumSize(QSize(687, 300))
        self.backButton.clicked.connect(self.on_backButton_clicked)
        self.closeButton.clicked.connect(self.on_closeButton_clicked)
        ...
        self.label_3.setText("Total Value: $" + str(cost_after_delivery))
        self.label_4.setText("Address: " + str(finaladdress))
        self.label_5.setText("Phone Number: " + str(finalphone_number))


        if item_1 > 0:
            self.label_8.setText(item1_name_final + ": $" + str(item_1))

        if item_2 > 0:
            self.label_9.setText(item2_name_final + ": $" + str(item_2))

        if item_3 > 0:
            self.label_11.setText(item3_name_final + ": $" + str(item_3))

        if item_4 > 0:
            self.label_14.setText(item4_name_final + ": $" + str(item_4))

        if item_5 > 0:
            self.label_13.setText(item5_name_final + ": $" + str(item_5))

        if item_6 > 0:
            self.label_15.setText(item6_name_final + ": $" + str(item_6))

        if item_7 > 0:
            self.label_12.setText(item7_name_final + ": $" + str(item_7))

        if item_8 > 0:
            self.label_16.setText(item8_name_final + ": $" + str(item_8))

        if item_9 > 0:
            self.label_17.setText(item9_name_final + ": $" + str(item_9))

        if item_10 > 0:
            self.label_18.setText(item10_name_final + ": $" + str(item_10))

        if deliverycheck == True:
            self.label_20.setText("Delivery Cost: $3")
        if deliverycheck == False:
            self.label_20.setText("Pickup Cost: $0")

        if papercheck == True:
            self.label_21.setText("Additional Paper Cost: $1")
        if papercheck == False:
            self.label_21.setText("Standard Box Cost: $0")
    ...
    def on_finishButton_clicked(self):
        f= open(str(finalfirstname) + str(finallastname)+".txt","w+")
        f.write("First Name: " + str(finalfirstname) + "\nLast Name: " + str(finallastname) + "\nAddress: " + str(finaladdress) + "\nPhone Number: " + str(finalphone_number) + "\nTotal Cost: $" + str(cost_after_delivery))
        if item_1 > 0:
            f.write("\n" + item1_name_final + ": $" + str(item_1))

        if item_2 > 0:
            f.write("\n" + item2_name_final + ": $" + str(item_2))

        if item_3 > 0:
            f.write("\n" + item3_name_final + ": $" + str(item_3))

        if item_4 > 0:
            f.write("\n" + item4_name_final + ": $" + str(item_4))

        if item_5 > 0:
            f.write("\n" + item5_name_final + ": $" + str(item_5))

        if item_6 > 0:
            f.write("\n" + item6_name_final + ": $" + str(item_6))

        if item_7 > 0:
            f.write("\n" + item7_name_final + ": $" + str(item_7))

        if item_8 > 0:
            f.write("\n" + item8_name_final + ": $" + str(item_8))

        if item_9 > 0:
            f.write("\n" + item9_name_final + ": $" + str(item_9))

        if item_10 > 0:
            f.write("\n" + item10_name_final + ": $" + str(item_10))
